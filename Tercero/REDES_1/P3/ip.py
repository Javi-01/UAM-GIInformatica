...
# Ethertype para identificar los datagramas IP
Ethertype = int('0x0800', 16)
...
def initIP(interface,opts=None):
    ...
    if ret == -1: # Si el nivel ARP no se ha inicializado
        return False

    # Obtener los datos y almacenarlos en las variables globales
    ...
    # Registramos la función process_IP_datagram
