...
public class ProcesaPago extends ServletRaiz {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Realizamos la captura de la excepxion de EJB que puede ser lanzada desde
        //realizarPago, de manera que si la captura, si existe una sesion activa,
        //la cierra, y devuelve un error de dicha excepcion
        try{
