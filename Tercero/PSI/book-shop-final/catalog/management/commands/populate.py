...
from catalog.models import (Author, Book, Comment, VoteBook)
from django.contrib.auth.models import User
from catalog.vote import update_book_score
...
class Command(BaseCommand):
    ...
    '''
        @function: votes
        @brief: Function in charge of generating votes.
        @author: Javier Fraile Iglesias
    '''
    ...
    def votes(self):
        ...
        for i in range(0, self.MAX_VOTES):
            num_user = random.randint(0, self.NUMBERUSERS - 2)
            num_book = random.randint(0, self.NUMBERBOOKS - 1)
            vote = VoteBook(
                book=books[num_book],
            ...
            vote.save()
            update_book_score(books[num_book])
