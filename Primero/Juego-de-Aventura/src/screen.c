...
#define ROWS 39                         /*!< Número de filas de la pantalla */
#define COLUMNS 115                     /*!< Número de columnas de la pantalla */
#define TOTAL_DATA (ROWS * COLUMNS) + 1 /*!< Cantidad total de datos del area */
#define BG_CHAR '~'                     /*!< caracter del background */
#define FG_CHAR ' '                     /*!< Caracter del foreground */
#define PROMPT " prompt:> "             /*!< cadena del prompt */

#define ACCESS(d, x, y) (d + ((y)*COLUMNS) + (x)) /*!< access */

/* Area structure*/
struct _Area /*!< Estructura de área */
{
  int x;        /*!< Coordenada x */
  int y;        /*!< Coordenada y */
  int width;    /*!< Ancho */
...
/**
* @brief COntrola los rangos del cursor
*
* @author Profesores PPROG
*/
...
/**
* @brief Hace scroll de la pantalla según el ancho del área
*
* @author Profesores PPROG
*/
...
/**
* @brief Cambia los signos con tildes
*
* @author Profesores PPROG
*/
