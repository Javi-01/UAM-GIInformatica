...
ax[2, 1].plot(wData[:, 0], wData[:, 1], color=(
    0.3, 0.3, 0.3), lw=1.5, label=r"$R_1$")
ax[2, 1].plot(wData[:, 0], wData[:, 4], color=(
    1.0, 0.5, 0.1), lw=1.5, label=r"$R_4$")
...
ax[2, 1].legend(frameon=False, fontsize=12,
                bbox_to_anchor=(-0.08, 0.9), handletextpad=0)

ax[3, 0].plot(bData[:, 0], bData[:, 2], '--',
              color=(0.3, 0.3, 0.3), lw=1.5, zorder=3)
ax[3, 0].plot(bData[:, 0], bData[:, 3], color=(
    1.0, 0.5, 0.1), lw=1.5, zorder=1)
ax[3, 0].set_ylim(3.2, 12.9)
ax[3, 1].plot(wData[:, 0], wData[:, 2], color=(
    0.3, 0.3, 0.3), lw=1.5, label=r"$R_2$")
ax[3, 1].plot(wData[:, 0], wData[:, 3], color=(
    1.0, 0.5, 0.1), lw=1.5, label=r"$R_3$")
ax[3, 1].set_ylim(3.2, 12.9)
ax[3, 0].set_yticks(np.arange(5., 12.5, 2))
ax[3, 1].set_yticks(np.arange(5., 12.5, 2))

ax[3, 1].legend(frameon=False, fontsize=12,
                bbox_to_anchor=(-0.08, 0.9), handletextpad=0)
...
ax[4, 1].plot(wData[:, 0], wData[:, 5], '-',
              color=(0.3, 0.3, 0.3), lw=1.5, label=r"$R_5$")
ax[4, 1].plot(wData[:, 0], wData[:, 6], '-',
              color=(1.0, 0.5, 0.1), lw=1.5, label=r"$R_6$")
ax[4, 1].set_ylim(3., 15)
ax[4, 0].set_yticks(np.arange(4., 12.5, 4))
ax[4, 1].set_yticks(np.arange(4., 12.5, 4))

ax[4, 1].legend(frameon=False, fontsize=12,
                bbox_to_anchor=(-0.08, 0.9), handletextpad=0)
...
ax[5, 1].plot(wData[:, 0], wData[:, 7], '-',
              color=(0.3, 0.3, 0.3), lw=1.5, label=r"$R_7$")
ax[5, 1].plot(wData[:, 0], wData[:, 8], '-',
              color=(1.0, 0.5, 0.1), lw=1.5, label=r"$R_8$")
ax[5, 1].set_ylim(1.1, 6.8)
ax[5, 0].set_yticks(np.arange(2., 6.5, 2))
ax[5, 1].set_yticks(np.arange(2., 6.5, 2))

ax[5, 1].legend(frameon=False, fontsize=12,
                bbox_to_anchor=(-0.08, 0.9), handletextpad=0)
