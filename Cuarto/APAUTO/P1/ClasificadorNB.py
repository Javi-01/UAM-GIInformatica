...
class ClasificadorNaiveBayes(Clasificador):
    ...
    def entrenamiento(self, datosTrain, nominalAtributos, diccionario):
        ...
        for class_, counts in zip(values_class, counts_class):
            ...
            #         for attr_val in range(0, fila - 1):
            #             if nominalAtributos[attr_val] == False:
            #                 if datosTrain[fila][attr_val] == 0:
        ...
        for attr in diccionario.keys():
            ...
            if nominalAtributos[attr_cont] == True:
                ...
                for class_key, counts in zip(self.verosimilitudes[attr].keys(), counts_class):
            ...
            for class_key in self.prioris.keys():
                ...
                for attr in diccionario.keys():
                    ...
                    # Para atributos continuos
                        ...
                        exponent = np.e * \
                            np.exp(-((fila[cont_attr] - mean)
                                   * np.exp(2)) / (2 * (desv * np.exp(2))))
